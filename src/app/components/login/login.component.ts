...
import { UploadComponent } from '../uploadimage/upload.component'; // Correct path to your upload component

@Component({
  selector: 'app-login',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterOutlet, UploadComponent],
